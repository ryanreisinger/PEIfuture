...
# Summer
tiff(
  file = paste0("./Data/predictionOutput/habitat_importance_change_summer.tiff"),
  width = 7.85,
  height = 6.4,
  units = "in",
  res = 300,
...
# Winter
tiff(
  file = paste0("./Data/predictionOutput/habitat_importance_change_winter.tiff"),
  width = 7.85,
  height = 6.4,
  units = "in",
  res = 300,
...
# Summer
tiff(
  file = paste0("./Data/predictionOutput/aes_change_summer.tiff"),
  width = 7.85,
  height = 6.4,
  units = "in",
  res = 300,
