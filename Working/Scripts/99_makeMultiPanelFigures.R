...
tiff(paste0("./Data/compiledPlots/mean_difference_", which_season, "_", which_scenario, ".tiff"), units="in", width=8.3, height=10, res=300, compression = 'lzw')
...
tiff(paste0("./Data/compiledPlots/sd_difference_", which_season, "_", which_scenario, ".tiff"), units="in", width=8.3, height=10, res=300, compression = 'lzw')
par(mfrow = c(4, 3), mai = c(0,0,0,0), oma = c(0, 0.5, 3, 0))
for (i in these_these_files) {
  this <- image_read(i)
  plot(this)
...
tiff(paste0("./Data/compiledPlots/mean_habitat_importance_change.tiff"), units="in", width=8, height=7, res=300, compression = 'lzw')
...
tiff(paste0("./Data/compiledPlots/climate_analogue_mean.tiff"), units="in", width=8, height=7, res=300, compression = 'lzw')
...
tiff(paste0("./Data/compiledPlots/climate_analogue_sd.tiff"), units="in", width=8, height=7, res=300, compression = 'lzw')
par(mfrow = c(2, 2), mai = c(0.1,0,0,0), oma = c(0, 0, 1.5, 0))
