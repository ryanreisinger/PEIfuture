...
for (i in 1:length(all.climate.mods)) {
  ...
  fut.rst <- raster(
              paste0("./Data/predictionOutput/rasters/pred_", this.species, "_", this.climate, "_", this.season, "_future_", this.scenario, ".grd"))
...
writeRaster(mean.diff, paste0("./Data/predictionOutput/perSpecies/rasters/meandiff_",
                      this.species, "_", this.season, "_", this.scenario, ".grd"), format = "raster",
            overwrite = T)
...
saveRDS(all.geomeans, paste0("./Data/predictionOutput/perSpecies/dataframes/rangeCenters_",
                             this.species, "_", this.season, "_", this.scenario, ".RDS"))
# The distances
...
pdf(paste0("./Data/predictionOutput/distanceChange/",
                      this.species, "_", this.season, "_", this.scenario, ".pdf"), paper = "a4")
...
# Plot mean
tiff(
  file = paste0("./Data/predictionOutput/perSpecies/plots/", this.species, "_", this.season, "_", this.scenario, "_mean_difference_BASE.tiff"),
  width = 8.085*0.8,
  height = 6.4*0.8,
  units = "in",
  res = 300,
...
# Plot uncertainty
tiff(
  file = paste0("./Data/predictionOutput/perSpecies/plots/", this.species, "_", this.season, "_", this.scenario, "_sd_difference_BASE.tiff"),
  width = 7.5*0.8,
  height = 7.475*0.8,
  units = "in",
  res = 300,
...
tiff(
  file = paste0("./Data/predictionOutput/perSpecies/plots/", this.species, "_", this.season, "_", this.scenario, "_mean_difference.tiff"),
  width = 8.75*0.8,
  height = 7.2*0.9,
  units = "in",
  res = 300,
