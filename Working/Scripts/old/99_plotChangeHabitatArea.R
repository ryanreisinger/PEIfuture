...
# Plot
pdf("./Data/other/habitat_area_change.pdf", width = 8.5, height = 5, useDingbats = F)
ggplot(data = big_hold, aes(x = change, y = species, color = climate)) +
