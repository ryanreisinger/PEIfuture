...
fut.grid <- readRDS(paste0("./Data/predictionGrids/predGrid_", this.climate, "_", this.season, "_rcp85.RDS"))
...
saveRDS(this.gower, paste0("./Data/climateOutput/gower_", this.season, "_", this.climate, ".RDS"))
...
saveRDS(foo, paste0("./Data/climateOutput/gowerDistanceBearing_", this.season, "_", this.climate, ".RDS"))
...
for (j in all.climate.mods) {
  ...
  d <- readRDS(paste0("./Data/climateOutput/gowerDistanceBearing_", this.season, "_", this.climate, ".RDS"))
  ...
  tiff(
    file = paste0("./Data/climateOutputPlots/Distance/", this.climate, "_", this.season, ".tiff"),
    width = 6.55,
    height = 6.607833,
    units = "in",
    res = 300,
  ...
  png(paste0("./Data/climateOutputPlots/Bearing/", this.climate, "_", this.season, ".png"),
  ...
  p <- ggplot(data = d, aes(x = bearing2)) +
    ...
    theme_bw() +
    labs(x = "Bearing (\u00B0)", y = "Count", title = paste(this.climate, "-", this.season, sep = " ")) +
...
tiff(
  file = paste0("./Data/climateOutputPlots/", "meanDistance_", this.season, ".tiff"),
  width = 6.55,
  height = 6.607833,
  units = "in",
  res = 300,
...
tiff(
  file = paste0("./Data/climateOutputPlots/", "sdDistance_", this.season, ".tiff"),
  width = 6.55,
  height = 6.607833,
  units = "in",
  res = 300,
...
pdf(paste0("./Data/climateOutputPlots/", "analogueBearing_", this.season, ".pdf"),
